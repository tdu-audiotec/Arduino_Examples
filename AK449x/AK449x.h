...
public:
    ...
    void DIF(uint8_t ChipSelect, uint8_t ChipNum, uint8_t OpMode);
    void ECS(uint8_t ChipSelect, uint8_t ChipNum, boolean FuncEnable);
    void EXDF(uint8_t ChipSelect, uint8_t ChipNum, boolean FuncEnable);
    void ACKS(uint8_t ChipSelect, uint8_t ChipNum, boolean FuncEnable);
    void SMUTE(uint8_t ChipSelect, uint8_t ChipNum, boolean FuncEnable);
    void DEM(uint8_t ChipSelect, uint8_t ChipNum, uint8_t OpMode);
    void DFS(uint8_t ChipSelect, uint8_t ChipNum, uint8_t OpMode);
    void SD(uint8_t ChipSelect, uint8_t ChipNum, uint8_t OpMode);
    void DZFM(uint8_t ChipSelect, uint8_t ChipNum, boolean FuncEnable);
    void DZFE(uint8_t ChipSelect, uint8_t ChipNum, boolean FuncEnable);
    void SELLR(uint8_t ChipSelect, uint8_t ChipNum, boolean FuncEnable);
    void DZFB(uint8_t ChipSelect, uint8_t ChipNum, boolean FuncEnable);
    void MONO(uint8_t ChipSelect, uint8_t ChipNum, boolean FuncEnable);
    void DCKB(uint8_t ChipSelect, uint8_t ChipNum, boolean FuncEnable);
    void DCKS(uint8_t ChipSelect, uint8_t ChipNum, boolean FuncEnable);
    void DP(uint8_t ChipSelect, uint8_t ChipNum, boolean FuncEnable);
    void LATT(uint8_t ChipSelect, uint8_t ChipNum, uint8_t OpMode);
    void RATT(uint8_t ChipSelect, uint8_t ChipNum, uint8_t OpMode);
    void SSLOW(uint8_t ChipSelect, uint8_t ChipNum, boolean FuncEnable);
    void INVR(uint8_t ChipSelect, uint8_t ChipNum, boolean FuncEnable);
    void INVL(uint8_t ChipSelect, uint8_t ChipNum, boolean FuncEnable);
    void DSDSEL(uint8_t ChipSelect, uint8_t ChipNum, int ModelNum, uint8_t OpMode);
    void DSDD(uint8_t ChipSelect, uint8_t ChipNum, int ModelNum, uint8_t OpMode);
    void DMRE(uint8_t ChipSelect, uint8_t ChipNum, int ModelNum, boolean FuncEnable);
    void DMC(uint8_t ChipSelect, uint8_t ChipNum, int ModelNum, boolean FuncEnable);
    void DMR(uint8_t ChipSelect, uint8_t ChipNum, int ModelNum, boolean FuncEnable);
    void DML(uint8_t ChipSelect, uint8_t ChipNum, int ModelNum, boolean FuncEnable);
    void DDM(uint8_t ChipSelect, uint8_t ChipNum, int ModelNum, boolean FuncEnable);
    void SYNCE(uint8_t ChipSelect, uint8_t ChipNum, int ModelNum, boolean FuncEnable);
    void SC(uint8_t ChipSelect, uint8_t ChipNum, int ModelNum, uint8_t OpMode);
    void DSDF(uint8_t ChipSelect, uint8_t ChipNum, int ModelNum, boolean FuncEnable);
private:
